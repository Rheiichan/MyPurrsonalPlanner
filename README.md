...
- My Profile (linked from every page's top bar, and from the Hub) — view your linked email, change your password, edit your name/birthday/height/weight, and a "reset my data" danger zone that clears your logged content (calendar, mood, sleep, goals, gratitude, achievements, diary, self-care, recipes, grocery) while keeping your account and profile
...
Budgeting, Project Planner, Travel Planner, 5 customizable Notebooks.
